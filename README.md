...
and state rules unless you set one). With **Ripple width** and **Ripple direction** the width of the ripple can be limited. This is intended for sensors mounted to a wall, which cannot detect presence or motion all around them.
